    ...
    def get_Video_info(self):
        ...
        with yt_dlp.YoutubeDL(ydl_opts) as ydl:
            ...
            if self.isPlayList == "playlist":
                try:
                    self.YTP_title = B["title"]                                                                       # Title of the video..........
                    self.YTP_VideoCount = B["playlist_count"]                                                         # Video count of playlist......
                    self.YTP_ViewCount = B["view_count"]                                                              # View count of playlist ......
                    Date = B["modified_date"]                                                                         # Last modified time ..........
                    ...
                    self.MainCode.label_Title_YTP.setText(f'{self.YTP_title}')                                        # Printing title of video .....
                    self.MainCode.label_videoCount_YTP.setText(f'{self.YTP_VideoCount}')                              # Printing Video count of video .....
                    self.MainCode.label_Channel_YTP.setText(f'{self.channelName}')                                    # Printing Channel Name of video .....
                    self.MainCode.label_PlayListViews_YTP.setText(f'{self.YTP_ViewCount:,}')                          # Printing ViewCount of video .....
